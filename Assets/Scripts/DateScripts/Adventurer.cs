...
public class Adventurer : MonoBehaviour
{
    ...
    {
        gift = false;
        if(PlayerPrefs.GetInt("gift") == 2)
        {
            PlayerPrefs.SetInt("Score", PlayerPrefs.GetInt("Score") + 1);
        }
        if (PlayerPrefs.GetInt("gift") == 3)
        {
            PlayerPrefs.SetInt("Score", PlayerPrefs.GetInt("Score") + 1);
        }
    ...
    {
        opener = false;
        if (PlayerPrefs.GetInt("opener") == 2)
        {
            PlayerPrefs.SetInt("Score", PlayerPrefs.GetInt("Score") + 1);
        }
        if (PlayerPrefs.GetInt("opener") == 6)
        {
            PlayerPrefs.SetInt("Score", PlayerPrefs.GetInt("Score") + 1);
        }
    ...
    {
        convo = false;
        if (PlayerPrefs.GetInt("convo") == 4)
        {
            PlayerPrefs.SetInt("Score", PlayerPrefs.GetInt("Score") + 1);
        }
        if (PlayerPrefs.GetInt("convo") == 2)
        {
            PlayerPrefs.SetInt("Score", PlayerPrefs.GetInt("Score") + 1);
        }
    ...
    {
        closer = false;
        if (PlayerPrefs.GetInt("closer") == 4)
        {
            PlayerPrefs.SetInt("Score", PlayerPrefs.GetInt("Score") + 1);
        }
        if (PlayerPrefs.GetInt("closer") == 6)
        {
            PlayerPrefs.SetInt("Score", PlayerPrefs.GetInt("Score") + 1);
        }
